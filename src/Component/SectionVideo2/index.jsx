    ...
    return (
        <div className={styles.all + " col-12 "}>
            <div className='d-flex justify-content-between align-items-center position-relative ' >
                ...
                <img src={anamat} width={370} alt="" />
                <img src={telescop} width={290} alt="" />
                ...
                <div className={styles.points + " position-absolute col-12  d-flex flex-column justify-content-between align-items-center "}>
                    ...
                    <div className=' position-absolute col-12 container h-100 d-flex justify-content-center align-items-center mt-5' style={{ zIndex: 10 }} >
                        {
                            !isplaying && (
                                <div className={styles.bgcontainerimg + ' position-absolute col-10 h-100 d-flex justify-content-center align-items-center '}>
                                    <img src={videobg} className={styles.bgimg + '  w-100 h-100 '} style={{ objectFit: "cover", backgroundAttachment: "fixed" }} alt="" />
                                    <div className={styles.filter}>
                                    </div><button onClick={() => setModal(true)} className='position-absolute bg-white d-flex justify-content-center align-items-center'>
                                        <span></span>
                                    </button>
                    ...
                    <div className={styles.textandhexagon + ' container position-absolute flex-grow-1 d-flex flex-column justify-content-between align-items-center flex-grow-1  mt-5'}>
                        <div className={styles.texth4 + ' col-12   d-flex justify-content-center align-items-center  '}><h4 className='text-center col-8 text-center '>Our Laboratory conduct scientific research and
                            development in Energy & Technology.</h4>
                        </div>
                        <div className={styles.allhexagon + ' col-12  d-flex justify-content-center align-items-center '}>
                            <div className={styles.parenthexagon + ' container  d-flex justify-content-between align-items-baseline '}>
                                <div className='col-3 d-flex flex-column justify-content-center align-items-center text-center gap-3'>
                                    <div className={styles.hexagon + " d-flex justify-content-center align-items-center"} style={{ background: "#37aa67", color: "white", fontSize: "32px" }}><TbUserPlus /></div>
                                ...
                                <img src={line} width={180} alt="" />
                                <div className='col-3  d-flex flex-column justify-content-center align-items-center text-center gap-3 '>

                                    <div className={styles.hexagon + " d-flex justify-content-center align-items-center"} style={{ background: "#ffb806", color: "white", fontSize: "32px" }} ><LuNotebookPen /></div>
                                ...
                                <div className='col-3 d-flex flex-column justify-content-center align-items-center text-center gap-3'>
                                    <div className={styles.hexagon + " d-flex justify-content-center align-items-center"} style={{ background: "#ff414b", color: "white", fontSize: "32px" }}><TbPuzzle2 /></div>
                                    <div className='d-flex flex-column gap-1'>
