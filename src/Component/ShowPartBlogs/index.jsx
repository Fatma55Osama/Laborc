...
export default function ShowPartBlogs() {
    ...
    useEffect(() => {
        ...
        console.log('blogsperpage inside useEffect:', blogsperpage);
    ...
    return (
        <div className='col-12 d-flex align-items-center justify-content-center' id={styles.heightDiv}>
            <div className=' container col-12 d-flex flex-column gap-5 py-5 py-md-5  py-lg-0 '>
                <div className='' id={styles.updiv}>
                ...
                <div id={styles.downdiv} className='d-flex flex-wrap justify-content-between gap-4'>
                    {
                        dataBlog && dataBlog.slice(0, blogsperpage).map((el) => (
                            <div key={el.documentId} className='bg-white py-3 px-1  position-relative' id={styles.backcontent} style={{ width: 630 }}>
                                ...
                                <Link to={`/blogdetalis/${el.documentId}`} className='col-12 nav-link d-flex justify-content-end align-items-end '>
